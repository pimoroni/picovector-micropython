...
class image:
    ...
    def text(self, text: str, at: XY = None, font_size: float = 0,
        ...
        ("Draw text with the current font; returns the drawn bounding box as a "
         ...
         "With a rect the caret is left at (rect.x, one line below the last line "
         "drawn), so a following text() with no position continues under the "
         "block whatever the alignment was. "
